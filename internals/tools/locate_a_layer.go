...
func (gl *LocateALayer) Description() string {
	return `Provides step-by-step UI navigation instructions to find and enable a specific layer on the platform. Generates instructions based on layer type.`
}
